...
//             fontSize: "14",
//             fontColor: "#000000",
//             BGcolor: "#000000", // indication purpose only
//         }
...
//     console.log(activecell(address), "A");

//     // Modification
//     cellProp.bold = !cellProp.bold; // Data Change
//     cell.style.fontWeight = cellProp.bold ? "bold" : "normal"; // UI change (1)
//     bold.style.backgroundColor = cellProp.bold ? activeColorProp : inactiveColorProp; // UI change (1)
// })
...
//     italic.style.backgroundColor = cellProp.italic ? "activeColorProp" : "inactiveColorProp"; // UI change (1)
// })
...
//     underline.style.backgroundColor = cellProp.underline ? "activeColorProp" : "inactiveColorProp"; // UI change (1)
// })
...
//     fontFamily.value = cellProp.fontFamily; // UI change (1)
// })
...
//     fontColor.value = cellProp.fontColor; // UI change (1)
// })
...
//     BGcolor.value = cellProp.BGcolor; // UI change (1)
// })
...
//     let [rid, cid] = decodeRIDCIDfromAddress(address)
//     console.log(decodeRIDCIDfromAddress(address), "oooooooooooooo");
...
function getCellAndCellProp(address) {
    ...
    // Access cell & storage object
    let cell = document.querySelector(`.cell[rid="${rid}"][cid="${cid}"]`);
    console.log(sheetDB[rid], "rdddddddddddd");
    let cellProp = sheetDB[rid][cid];
    console.log(cellProp, "proppppppppp");
